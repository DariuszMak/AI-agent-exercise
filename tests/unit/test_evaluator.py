...
def test_below_min_results_fails() -> None:
...
def test_short_best_chunk_fails() -> None:
...
def test_best_chunk_exactly_20_chars_passes() -> None:
    evaluator = RAGEvaluator(relevance_threshold=0.1)
...
def test_best_chunk_19_chars_fails() -> None:
    evaluator = RAGEvaluator(relevance_threshold=0.1)
...
def test_picks_highest_score_as_best() -> None:
    evaluator = RAGEvaluator(relevance_threshold=0.5)
    docs = [
...
def test_reason_contains_threshold() -> None:
...
def test_missing_score_key_defaults_to_zero() -> None:
    evaluator = RAGEvaluator(relevance_threshold=0.1)
...
def test_min_results_exactly_met() -> None:
