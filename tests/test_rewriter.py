...
class TestRAGRewriterWithLLM:
    def test_rewrite_uses_llm_when_available(self) -> None:
        llm = MagicMock()
    ...
    def test_rewrite_strips_quotes(self) -> None:
        llm = MagicMock()
    ...
    def test_rewrite_strips_single_quotes(self) -> None:
        llm = MagicMock()
    ...
    def test_rewrite_falls_back_on_connection_error(self) -> None:
        llm = MagicMock()
    ...
    def test_rewrite_falls_back_on_value_error(self) -> None:
        llm = MagicMock()
    ...
    def test_rewrite_passes_temperature(self) -> None:
        llm = MagicMock()
...
class TestRAGRewriterHeuristic:
    ...
    def test_iteration_2_preserves_unique_words(self) -> None:
        rewriter = RAGRewriter(llm=None)
